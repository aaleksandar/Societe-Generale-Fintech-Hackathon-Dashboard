...
class IndicatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create indicator" do
    assert_difference('Indicator.count') do
      post indicators_url, params: { indicator: { name: @indicator.name, product: @indicator.product, score: @indicator.score } }
    end
  ...
  test "should update indicator" do
    patch indicator_url(@indicator), params: { indicator: { name: @indicator.name, product: @indicator.product, score: @indicator.score } }
